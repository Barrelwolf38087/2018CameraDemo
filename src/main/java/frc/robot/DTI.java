...
/**
 * Drive Team Interface.
 * This is a cleaner version of {@link frc.robot.OI OI}.
...
public class DTI {
	...
	public static Joystick driverStick = new Joystick(RobotMap.xboxControllerPort);
	public static Joystick operatorStick = new Joystick(RobotMap.nykoControllerPort);
